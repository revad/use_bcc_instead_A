UseBccInstead.UseBccInsteadUtil =
{
  NOTHING: -1,
  TO: 0,
  CC: 1,
  ...
  getLocalizedString: function(arg)
  {
    ...
    try
    {
      if(!this.stringBundle)
      {
        ...
        this.stringBundle = stringBundleService.createBundle ("chrome://usebccinstead/locale/prefs.properties");
      }
